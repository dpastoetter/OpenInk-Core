...
3. **Style** – Follow existing patterns: TypeScript strict, Preact functional components, semantic CSS classes and design tokens in `src/index.css`. No Tailwind; no `any`. See [docs/DEVELOPMENT.md](docs/DEVELOPMENT.md) for code style and conventions.
...
- **Security** – [docs/SECURITY.md](docs/SECURITY.md). Don’t add secrets; sanitize external content; use `isSafeUrl` for links/images.
